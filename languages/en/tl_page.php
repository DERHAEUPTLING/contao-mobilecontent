...
$GLOBALS['TL_LANG']['tl_page']['mobileDnsBreakpointDetection'] = ['Use breakpoint to detect mobile device', 'Use the breakpoint in pixels to detect the mobile device instead of regular Contao User-Agent detection.'];
